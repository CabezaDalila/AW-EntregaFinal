  ...
  template: `
    <header class="fixed w-full top-0 z-20 bg-purple-900">
      <div class="container mx-auto px-4 py-3">
        <div class="flex justify-between items-center">
          ...
          <button (click)="onLoginClick()" class="hidden lg:block bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded transition-colors">
            Iniciar sesión
          </button>
        </div>
      </div>
    ...
    <div [@slideInOut]="isMenuOpen ? 'in' : 'out'" 
      ...
      <div class="flex flex-col items-center justify-start h-full pt-20">
        ...
        <button (click)="onLoginClick()" class="mt-8 bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded transition-colors">
          Iniciar sesión
        </button>
