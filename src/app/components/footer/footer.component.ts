      ...
      <div class="container mx-auto px-4">
        <div class="flex flex-col md:flex-row md:justify-between">
          <div class="mb-6 md:mb-0">
            <h2 class="text-2xl font-bold mb-2">MockVest</h2>
            <p class="text-sm text-purple-200">Aprende. Invierte. Crece.</p>
          </div>
        ...
        <div class="mt-8 pt-8 border-t border-purple-800 text-sm text-center md:flex md:justify-between">
          <p>&copy; 2024 MockVest. Todos los derechos reservados.</p>
          <div class="mt-4 md:mt-0">
            <a href="#" class="hover:text-purple-200 transition-colors mr-4">Política de Privacidad</a>
            <a href="#" class="hover:text-purple-200 transition-colors">Términos de Servicio</a>
          </div>
        </div>
      </div>
    </footer>
