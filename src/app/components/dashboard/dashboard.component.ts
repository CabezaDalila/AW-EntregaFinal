...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, HeaderComponent, SideBarComponent, RouterModule, RouterOutlet, PortfolioSummaryComponent,StatsGridComponent,PortfolioDistributionComponent],
